...
+function ($)
{
  ...
  OffCanvas.prototype.calcPlacement = function ()
  {
    ...
    function ab(a, b)
    {
      ...
      var sizeB = parseInt(element.css(b), 10)
  ...
  OffCanvas.prototype.getCanvasElements = function ()
  {
    ...
    var fixedElements = canvas.find('*').filter(function ()
    {
  ...
  OffCanvas.prototype.show = function ()
  {
    ...
    if (elements.index(this.$element) !== -1) {
      ...
      // Workaround: Need to get the CSS property for it to be applied before the
      // next line of code
    }
  ...
  OffCanvas.prototype.toggleBackdrop = function (callback)
  {
    ...
    if (this.state == 'slide-out' && this.$backdrop) {
